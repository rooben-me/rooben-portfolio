...
const Card = ({ src, slug, roles }: ICard) => {
  return (
    <Link href={`/posts/${slug}`}>
      <a className="p-4 rounded-xl hover:bg-slate-100 active:border-slate-300 border border-transparent focus:ring-2 focus:ring-offset-2 focus:ring-primary-main">
